...
public class PlayerStatPane extends Pane{
	...
	public void setAll(PlayerStats playerStats) {
		hpbar.setValue(playerStats.getHealth());
		setlevel((int)playerStats.getLevel());
		this.setGold((int)playerStats.getGold());
		setExp((int)playerStats.getExp());
		setMaxExp((int)playerStats.getExpTillNext());
		this.setMaxMana((int)playerStats.getMaxmana());
		setMana((int)playerStats.getMana());
		setPName(playerStats.getName());
	}
}
