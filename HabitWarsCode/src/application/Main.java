...
public class Main extends Application {
	...
	private void startPro(TaskActionControler tac, Stage primaryStage) {
		// this creates the main page where you can create tasks and get scored.
		...
		Pane root = new Pane();
	     ...
	     main.setCenter(root);
	     tac.rewardPane.setLayoutX(320);
	     // this sets what the menu bar dose.
	     //logout 
		...
		//Create the button that adds a tasks
		...
		//sets the items to the page then display the main page
		tac.open();
