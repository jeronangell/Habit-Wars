...
public class PlayerStatPane extends Pane {
	...
	private fullstatPane hpbar = new fullstatPane(Color.RED, 50, 50, "HP", "hit points");
	private fullstatPane xpbar = new fullstatPane(Color.YELLOW, 100, 22, "XP", "experience");
	private fullstatPane manaBar = new fullstatPane(Color.BLUE, 100, 60, "MANA", "mana points or points for abilitys");
	private int mana = 0;
	private int exp = 0;
	...
	public PlayerStatPane() {
		...
		playername.setTooltip(new Tooltip("your Players Name"));
		hpbar.setLayoutY(20);
		hpbar.setLayoutX(25);
		...
		goldLbl.setText(goldAmnt + " gold");
		goldLbl.setTooltip(new Tooltip("the amount of gold you have"));
...
class fullstatPane extends Pane {
	...
	public fullstatPane(Color bc, int maxPnt, int curintval, String name, String tooltip) {
